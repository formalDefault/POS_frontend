                        ...
                        <div data-aos="fade-down" className="ml-150 mt-52 bg-white w-4/12 h-72 rounded-2xl p-4 border-2 shadow-xl ">
                            ...
                            <div className="h-72">
                                ...
                                <div name="botones" className=" text-2xl w-11/12 absolute bottom-10 flex justify-between pl-12 pr-6">
                                    <div className="bg-green-600 text-white px-4 py-1 rounded-lg cursor-pointer hover:shadow-xl transition duration-500 ">
                                        <h1>Aceptar</h1>
                                    </div>
                                    <div className="bg-red-600 text-white px-4 py-1 rounded-lg cursor-pointer hover:shadow-xl transition duration-500 ">
                                        <h1>Cancelar</h1>
                                    </div>
                                </div>
                            </div>
